ITD110 Lab Exercise 1 – StudentDB (Redis)

A simple CRUD application using a Node.js/Express backend integrated with a Redis key-value store and a modern Vanilla JavaScript frontend.
...
Gemini said
Understood! I've removed the comparisons to MongoDB and focused entirely on the Redis architecture as requested for your Lab 2 submission.
